...
function CourseOutline() {
    ...
    return (
        <>
                ...
                <div>
                    <div>
                        ...
                        <ul className={styles.checklist}>
                            <li>
                                WHy the bnjjis Have the mire the merrier the en
                                will fine dout Whre erevt trewve thhelwkmskop
                                the womwn married a low life
                            </li>
                            <li>
                                WHy the bnjjis Have the mire the merrier the en
                                will fine dout Whre erevt trewve thhelwkmskop
                    ...
                    <div>
                        <h2>Description</h2>
                        <p>
                            A Description On this course More like A summary of
                            what students would expect to learn who the course
                            is for and why they should enroll to take the
                            course.A Description On this course More like A
                            summary of what students would expect to learn who
                            the course is for and why they should enroll to take
                            the courseA Description On this course More like A
                            summary of what students would expect to learn who
                            the course is for and why they should enroll to take
                            the courseA Description On this course More like A
                            summary of what students would expect to learn who
            ...
            <section className={styles.course_instructor}>
                <section>
                    <h2>Instructor</h2>
                    ...
                    <div className={styles.course_instructor_detail}>
                        <div className={styles.instructor_profile}>
                            {false ? (
                                <img src="" alt="" title="" width={130} height={130} />
                            ) : (
                                <h3>AE</h3>
                            )}
                        </div>
