                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="#"
                                ...
                                <img src="{{ $message->embed(public_path('/logo.webp')) }}" class="logo"
                                    alt="Laravel Logo"
                                    ...
                                    <p><span style="color: white">STACK</span><span style="color:green">CLIQUE</span></p>
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            Thanks for Signing up use the pin below to verify your account.</p>
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <a href="#"
                                                                                ...
                                                                                border-top: 8px solid #2d3748;">Verification Pin
                                                                                {{$verf_dets['verf_pin']}}</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
